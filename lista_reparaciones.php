...
<html lang="en">
  ...
  <div class="row">
    ...
    <tr>
      ...
      <td><?php echo $mostrar['accesesorios'] ?></td>
      <td><?php echo $mostrar['fecha_entrada'] ?></td>
      <td><?php echo $mostrar['fecha_salida'] ?></td>
      <td><?php echo $mostrar['costo'] ?></td>
      <td><?php echo $mostrar['codigo_cliente'] ?></td>
      <td>
        <a href="modificar_cliente.php?id=<?php echo  "{$mostrar['codigo']}"?>"><img src="images/editar.png"></a></td>
      <td> <a href="eliminar_cliente.php?id=<?php echo  "{$mostrar['codigo']}"?>"><img src="images/eliminar.png"></a></td>
    </tr>
  <?php 
  }
   ?>
